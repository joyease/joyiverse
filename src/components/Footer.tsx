...
export const Footer: React.FC<FooterProps> = ({ currentTab, onSelectTab }) => {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-40 bg-white/90 dark:bg-slate-900/90 backdrop-blur-lg border-t border-slate-200/80 dark:border-slate-800 transition-colors pb-safe">
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                ...
                />
                {isLocked && (
                  <span className="absolute -top-1 -right-2 w-3.5 h-3.5 rounded-full bg-slate-200 dark:bg-slate-700 flex items-center justify-center text-slate-500">
